...
namespace BlockeonsDratris.Audio
{
    public class BattleAudioController : MonoBehaviour
    {
        ...
        private int lastHeroHP = -1; // garantia para que o som de ferida do heroi so toque a cada queda de HP
        ...
        {
            // Só toca o som quando o HP realmente cair em relação ao valor anterior,
            // evitando que fique "preso" tocando sempre que current < max.
            if (lastHeroHP != -1 && current < lastHeroHP)
                Play(heroHurt);
